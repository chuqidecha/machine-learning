...
#%% 
# 保存训练数据
data_train.to_csv('./kaggle/bike-rental-predict/input/train_feature.csv',index=False)
...
#%%
data_test.to_csv('./kaggle/bike-rental-predict/input/test_feature.csv',index=False)